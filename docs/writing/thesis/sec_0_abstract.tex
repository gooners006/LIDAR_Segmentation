...
network completes each detected car's occluded surface. On sequence~08 (the single
reporting sequence, \num{4071} scans) the detector reaches precision \num{0.905},
recall \num{0.730}, and $F_1$ \num{0.808} at a point-IoU of \num{0.3}, with recall
measured against the car-only, at-least-ten-surviving-points denominator. The recall
