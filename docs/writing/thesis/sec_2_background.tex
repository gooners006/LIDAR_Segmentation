...
% ("Chapter~\ref{ch:pipeline}", "Section~\ref{sec:recall-analysis}", "Section~\ref{sec:donor-validation}") because the chapter files do not share a label
...
deferred to the method chapters (Chapter~\ref{ch:pipeline} for detection,
...
\emph{reference-free} completion metrics has grown up around the KITTI cars.
