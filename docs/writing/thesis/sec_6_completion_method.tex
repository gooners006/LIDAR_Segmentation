...
\section{Fix 1 --- KITTI-like partials}
...
\section{Fix 2 --- the inference-normalisation bug}
...
\section{Fix 3 --- the L-shape input gate}
...
\section{Fix 4 --- per-car length estimation}
