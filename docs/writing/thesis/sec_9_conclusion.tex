...
\begin{enumerate}
  ...
  completion half's central contribution (Chapter~\ref{ch:completion-eval}).
  ...
  are reported as findings in their own right (Chapter~\ref{ch:recall-bottleneck}).
  ...
  (Findings~\#25/\#30). This directly replaces a proposal contribution (Chapter~\ref{ch:detection-eval}).
\end{enumerate}
