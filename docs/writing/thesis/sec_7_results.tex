...
% is opened by sec_7_2_donor_metric.tex, which owns \label{sec:donor-validation}),
...
% ("Section~\ref{sec:donor-metric}", "Section~\ref{ch:completion-method}") rather than \ref{}; only within-file refs use \ref.
%
