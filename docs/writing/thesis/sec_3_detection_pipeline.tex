...
%
\chapter{The Detection Pipeline}
\label{ch:pipeline}

This chapter describes the car-detection pipeline that produces every detection
evaluated in Chapter~\ref{ch:detection-eval} and every cluster completed in Chapters~\ref{ch:completion-method} and~\ref{ch:completion-eval}. The
...
\section{Tracking and track-level filtering}
...
(Figure~\ref{fig:pipeline}, right) is the subject of Chapter~\ref{ch:completion-method}; the evaluation of
