...
\begin{figure}[H]
  ...
  \caption{The detection pipeline. Learned stages are shaded; all others are
    ...
    sequence~08 under the shipped (promoted) configuration
...
because it improves detection (discussed in Chapter~4); its effect on the measured
...
(\SI{6}{\percent}). Its individual gates are ablated in Chapter~4; here we note
