...
\section{What the thesis establishes}
...
conventional held-out detection test set. The shipped classifier was historically
...
shipped sequence-08 output --- the same \num{518} tracks of which the \num{119} fallback
...
\section{What generalises, and what is sequence-specific}
