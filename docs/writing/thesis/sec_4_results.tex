...
\subsection{Stage decomposition: what the classifier and track filter buy}
...
\subsection{Synthetic pretraining is redundant (Stage~A ablation)}
...
\subsection{Clustering method: HDBSCAN earns its cost}
