...
% \label{ch:evaluation}. At final assembly the assembler drops this
...
% sibling sections use typed numerals ("Section~\ref{sec:eval-protocol}", "Section~\ref{sec:recall-analysis}") exactly as
