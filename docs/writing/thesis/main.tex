...
\input{sec_3_detection_pipeline}      % opens Chapter 3 (Methodology): detection...
\input{sec_6_completion_method}       % ...+ object completion (folds under Methodology)
\input{sec_4_1_evaluation_protocol}   % opens Chapter 4 (Evaluation): protocol...
\input{sec_4_results}                 % ...detection results + ablations + range + runtime
\input{sec_5_recall_bottleneck}       % ...recall analysis = bridge to completion (was a chapter)
\input{sec_7_2_donor_metric}          % ...donor-metric validation battery (was a chapter)
\input{sec_7_results}                 % ...completion results: coverage, box, movers, held-out
\input{sec_8_discussion}              % opens Chapter 5 (Discussion and Conclusion): discussion + limitations...
\input{sec_9_conclusion}              % ...+ RQ answers, contributions, future work (folds under Ch5)
