...
\section{The shortfall as a clustering failure}
...
\section{Root cause: HDBSCAN fragmentation of large, close cars}
...
\section{Limits of the repair strategies}
\label{sec:repairs}
...
\section{Clustering resolution and the corrected ceiling}
