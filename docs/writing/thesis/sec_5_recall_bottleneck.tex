...
% and their tables use typed numerals ("Chapter~\ref{ch:evaluation}", "Section~\ref{sec:results-ablations}", "Table~4.1")
...
Chapter~\ref{ch:discussion}. Unless stated otherwise, the recall denominator
