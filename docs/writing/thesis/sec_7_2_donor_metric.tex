...
\subsection{Why Chamfer distance is invalid on real cars}
...
and hence why the completion work of Chapter~6 needed a different metric
altogether.
...
synthetic CD of Chapter~6 (\SI{0.16}{\meter}) measures the network on synthetic
...
a geometry change (the fixed length prior of Chapter~6) with this guard ---
