...
\section{Why Chamfer distance is invalid on real cars}
...
The trouble is that the accumulation is itself one-sided. A parked car is
...
\subsection{Reading the hallucination guard per band}
