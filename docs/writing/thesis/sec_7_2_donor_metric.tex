...
%
With the detection front-end characterised, the chapter turns to its centre: the
completion evaluation, carried by the contribution. The donor-frame metric it uses
