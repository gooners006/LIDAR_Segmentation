...
% ("Chapter~\ref{ch:pipeline}", "Section~7.4") because the chapter files do not share a label
...
leakage-free donor-frame coverage metric that scores how much genuinely occluded
