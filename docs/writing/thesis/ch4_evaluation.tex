...
\begin{table}[H]
  \centering
  \caption{Per-frame runtime by stage on the full sequence~08 under the final
...
itself a contribution, and it is what justifies the residual limitation carried to
...
contribution of this analysis is to have located the ceiling precisely --- it is in
...
\begin{figure}[htbp]
  ...
  \caption{The donor metric in bird's-eye view on six seq-08 cars, spanning the
...
rescale). Section~\ref{ch:completion-method} investigated this under pre-registration (Finding~\#45, the
