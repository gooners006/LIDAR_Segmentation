...
partially replicates on a pre-registered held-out sequence. Along the way, the detection
front-end is found to be recall-limited by clustering rather than the classifier, and
